...
class numinwordsPTBRTest(TestCase):
    ...
    def test_cardinal_integer(self):
        self.assertEqual(numinwords(1, lang='pt_BR'), 'um')
        self.assertEqual(numinwords(2, lang='pt_BR'), 'dois')
        self.assertEqual(numinwords(3, lang='pt_BR'), 'três')
        self.assertEqual(numinwords(4, lang='pt_BR'), 'quatro')
        self.assertEqual(numinwords(5, lang='pt_BR'), 'cinco')
        self.assertEqual(numinwords(6, lang='pt_BR'), 'seis')
        self.assertEqual(numinwords(7, lang='pt_BR'), 'sete')
        self.assertEqual(numinwords(8, lang='pt_BR'), 'oito')
        self.assertEqual(numinwords(9, lang='pt_BR'), 'nove')
        self.assertEqual(numinwords(10, lang='pt_BR'), 'dez')
        self.assertEqual(numinwords(11, lang='pt_BR'), 'onze')
        self.assertEqual(numinwords(12, lang='pt_BR'), 'doze')
        self.assertEqual(numinwords(13, lang='pt_BR'), 'treze')
        self.assertEqual(numinwords(14, lang='pt_BR'), 'catorze')
        self.assertEqual(numinwords(15, lang='pt_BR'), 'quinze')
        self.assertEqual(numinwords(16, lang='pt_BR'), 'dezesseis')
        self.assertEqual(numinwords(17, lang='pt_BR'), 'dezessete')
        self.assertEqual(numinwords(18, lang='pt_BR'), 'dezoito')
        self.assertEqual(numinwords(19, lang='pt_BR'), 'dezenove')
        self.assertEqual(numinwords(20, lang='pt_BR'), 'vinte')

        self.assertEqual(numinwords(21, lang='pt_BR'), 'vinte e um')
        self.assertEqual(numinwords(22, lang='pt_BR'), 'vinte e dois')
        self.assertEqual(numinwords(35, lang='pt_BR'), 'trinta e cinco')
        self.assertEqual(numinwords(99, lang='pt_BR'), 'noventa e nove')

        self.assertEqual(numinwords(100, lang='pt_BR'), 'cem')
        self.assertEqual(numinwords(101, lang='pt_BR'), 'cento e um')
        self.assertEqual(numinwords(128, lang='pt_BR'), 'cento e vinte e oito')
        self.assertEqual(numinwords(713, lang='pt_BR'), 'setecentos e treze')

        self.assertEqual(numinwords(1000, lang='pt_BR'), 'mil')
        self.assertEqual(numinwords(1001, lang='pt_BR'), 'mil e um')
        self.assertEqual(numinwords(1111, lang='pt_BR'), 'mil, cento e onze')
        self.assertEqual(
            numinwords(2114, lang='pt_BR'), 'dois mil, cento e catorze'
        )
        self.assertEqual(
            numinwords(73421, lang='pt_BR'),
            'setenta e três mil, quatrocentos e vinte e um'
        )

        self.assertEqual(numinwords(100000, lang='pt_BR'), 'cem mil')
        self.assertEqual(
            numinwords(250050, lang='pt_BR'),
            'duzentos e cinquenta mil e cinquenta'
        )
        self.assertEqual(
            numinwords(6000000, lang='pt_BR'), 'seis milhões'
        )
        self.assertEqual(
            numinwords(19000000000, lang='pt_BR'), 'dezenove bilhões'
        )
        self.assertEqual(
            numinwords(145000000002, lang='pt_BR'),
            'cento e quarenta e cinco bilhões e dois'
        )

    def test_cardinal_integer_negative(self):
        self.assertEqual(numinwords(-1, lang='pt_BR'), 'menos um')
        self.assertEqual(
            numinwords(-256, lang='pt_BR'), 'menos duzentos e cinquenta e seis'
        )
        self.assertEqual(numinwords(-1000, lang='pt_BR'), 'menos mil')
        self.assertEqual(numinwords(-1000000, lang='pt_BR'), 'menos um milhão')
        self.assertEqual(
            numinwords(-1234567, lang='pt_BR'),
            'menos um milhão, duzentos e trinta e quatro mil, quinhentos e '
            'sessenta e sete'
        )

    def test_cardinal_float(self):
        self.assertEqual(numinwords(Decimal('1.00'), lang='pt_BR'), 'um')
        ...
        self.assertEqual(
            numinwords(Decimal('3.14159'), lang='pt_BR'),
            'três vírgula um quatro um cinco nove'
        )
        self.assertEqual(
            numinwords(Decimal('101.22'), lang='pt_BR'),
            'cento e um vírgula dois dois'
        )
        self.assertEqual(
            numinwords(Decimal('2345.75'), lang='pt_BR'),
            'dois mil, trezentos e quarenta e cinco vírgula sete cinco')

    def test_cardinal_float_negative(self):
        self.assertEqual(
            numinwords(Decimal('-2.34'), lang='pt_BR'),
            'menos dois vírgula três quatro'
        )
        self.assertEqual(
            numinwords(Decimal('-9.99'), lang='pt_BR'),
            'menos nove vírgula nove nove'
        )
        self.assertEqual(
            numinwords(Decimal('-7.01'), lang='pt_BR'),
            'menos sete vírgula zero um'
        )
        self.assertEqual(
            numinwords(Decimal('-222.22'), lang='pt_BR'),
            'menos duzentos e vinte e dois vírgula dois dois'
        )

    def test_ordinal(self):
        self.assertEqual(numinwords(1, lang='pt_BR', ordinal=True), 'primeiro')
        self.assertEqual(numinwords(2, lang='pt_BR', ordinal=True), 'segundo')
        self.assertEqual(numinwords(3, lang='pt_BR', ordinal=True), 'terceiro')
        self.assertEqual(numinwords(4, lang='pt_BR', ordinal=True), 'quarto')
        self.assertEqual(numinwords(5, lang='pt_BR', ordinal=True), 'quinto')
        self.assertEqual(numinwords(6, lang='pt_BR', ordinal=True), 'sexto')
        self.assertEqual(numinwords(7, lang='pt_BR', ordinal=True), 'sétimo')
        self.assertEqual(numinwords(8, lang='pt_BR', ordinal=True), 'oitavo')
        self.assertEqual(numinwords(9, lang='pt_BR', ordinal=True), 'nono')
        self.assertEqual(numinwords(10, lang='pt_BR', ordinal=True), 'décimo')
        self.assertEqual(
            numinwords(11, lang='pt_BR', ordinal=True), 'décimo primeiro'
        )
        self.assertEqual(
            numinwords(12, lang='pt_BR', ordinal=True), 'décimo segundo'
        )
        self.assertEqual(
            numinwords(13, lang='pt_BR', ordinal=True), 'décimo terceiro'
        )
        self.assertEqual(
            numinwords(14, lang='pt_BR', ordinal=True), 'décimo quarto'
        )
        self.assertEqual(
            numinwords(15, lang='pt_BR', ordinal=True), 'décimo quinto'
        )
        self.assertEqual(
            numinwords(16, lang='pt_BR', ordinal=True), 'décimo sexto'
        )
        self.assertEqual(
            numinwords(17, lang='pt_BR', ordinal=True), 'décimo sétimo'
        )
        self.assertEqual(
            numinwords(18, lang='pt_BR', ordinal=True), 'décimo oitavo'
        )
        self.assertEqual(
            numinwords(19, lang='pt_BR', ordinal=True), 'décimo nono'
        )
        self.assertEqual(
            numinwords(20, lang='pt_BR', ordinal=True), 'vigésimo'
        )

        self.assertEqual(
            numinwords(21, lang='pt_BR', ordinal=True), 'vigésimo primeiro'
        )
        self.assertEqual(
            numinwords(22, lang='pt_BR', ordinal=True), 'vigésimo segundo'
        )
        self.assertEqual(
            numinwords(35, lang='pt_BR', ordinal=True), 'trigésimo quinto'
        )
        self.assertEqual(
            numinwords(99, lang='pt_BR', ordinal=True), 'nonagésimo nono'
        )

        self.assertEqual(
            numinwords(100, lang='pt_BR', ordinal=True), 'centésimo'
        )
        self.assertEqual(
            numinwords(101, lang='pt_BR', ordinal=True), 'centésimo primeiro'
        )
        self.assertEqual(
            numinwords(128, lang='pt_BR', ordinal=True),
            'centésimo vigésimo oitavo'
        )
        self.assertEqual(
            numinwords(713, lang='pt_BR', ordinal=True),
            'septigentésimo décimo terceiro'
        )

        self.assertEqual(
            numinwords(1000, lang='pt_BR', ordinal=True), 'milésimo'
        )
        self.assertEqual(
            numinwords(1001, lang='pt_BR', ordinal=True), 'milésimo primeiro'
        )
        self.assertEqual(
            numinwords(1111, lang='pt_BR', ordinal=True),
            'milésimo centésimo décimo primeiro'
        )
        self.assertEqual(
            numinwords(2114, lang='pt_BR', ordinal=True),
            'segundo milésimo centésimo décimo quarto'
        )
        self.assertEqual(
            numinwords(73421, lang='pt_BR', ordinal=True),
            'septuagésimo terceiro milésimo quadrigentésimo vigésimo primeiro'
        )

        self.assertEqual(
            numinwords(100000, lang='pt_BR', ordinal=True),
            'centésimo milésimo'
        )
        self.assertEqual(
            numinwords(250050, lang='pt_BR', ordinal=True),
        ...
        self.assertEqual(
            numinwords(145000000002, lang='pt_BR', ordinal=True),

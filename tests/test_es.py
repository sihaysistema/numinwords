...
class numinwordsESTest(TestCase):
    ...
    def test_number(self):
        for test in TEST_CASES_CARDINAL:
            self.assertEqual(numinwords(test[0], lang='es'), test[1])

    def test_ordinal(self):
        for test in TEST_CASES_ORDINAL:
            self.assertEqual(
                numinwords(test[0], lang='es', ordinal=True),
                test[1]
            )
    ...
    def test_currency(self):
        for test in TEST_CASES_TO_CURRENCY:
            self.assertEqual(
                numinwords(test[0], lang='es', to='currency'),
                test[1]
            )
    ...
    def test_currency_esp(self):
        for test in TEST_CASES_TO_CURRENCY_ESP:
            self.assertEqual(
                numinwords(test[0], lang='es', to='currency', currency='ESP'),
                test[1]
            )
    ...
    def test_currency_usd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                numinwords(test[0], lang='es', to='currency', currency='USD'),
                test[1]
            )
    ...
    def test_currency_pen(self):
        for test in TEST_CASES_TO_CURRENCY_PEN:
            self.assertEqual(
                numinwords(test[0], lang='es', to='currency', currency='PEN'),
                test[1]
            )
    ...
    def test_currency_gtq(self):
        for test in TEST_CASES_TO_CURRENCY_GTQ:
            self.assertEqual(
                numinwords(test[0], lang='es', to='currency', currency='GTQ'),
                test[1]
            )

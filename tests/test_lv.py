...
class numinwordsLVTest(TestCase):
    def test_to_cardinal(self):
        self.assertEqual(numinwords(100, lang='lv'), 'simts')
        self.assertEqual(numinwords(101, lang='lv'), 'simtu viens')
        self.assertEqual(numinwords(110, lang='lv'), 'simts desmit')
        self.assertEqual(numinwords(115, lang='lv'), 'simts piecpadsmit')
        self.assertEqual(numinwords(123, lang='lv'), 'simts divdesmit trīs')
        self.assertEqual(numinwords(1000, lang='lv'), 'tūkstotis')
        self.assertEqual(numinwords(1001, lang='lv'), 'tūkstotis viens')
        self.assertEqual(numinwords(2012, lang='lv'),
                         'divi tūkstoši divpadsmit')
        self.assertEqual(
            numinwords(1234567890, lang='lv'),
            'miljards divi simti trīsdesmit četri miljoni pieci simti '
            'sešdesmit septiņi tūkstoši astoņi simti deviņdesmit')
        self.assertEqual(
            numinwords(215461407892039002157189883901676, lang='lv'),
        ...
        self.assertEqual(
            numinwords(719094234693663034822824384220291, lang='lv'),
        ...
        self.assertEqual(
            numinwords(-5000, lang='lv'),
            'mīnus pieci tūkstoši',
        )
        self.assertEqual(
            numinwords(-5000.22, lang='lv'),
            'mīnus pieci tūkstoši komats divdesmit divi',
        )

        self.assertEqual(numinwords(0, lang='lv'), 'nulle')
        self.assertEqual(numinwords(5, lang='lv'), "pieci")
        self.assertEqual(numinwords(15, lang='lv'), "piecpadsmit")
        self.assertEqual(numinwords(154, lang='lv'), "simts piecdesmit četri")
        self.assertEqual(numinwords(101, lang='lv'), "simtu viens")
        self.assertEqual(
            numinwords(1135, lang='lv'), "tūkstotis simts trīsdesmit pieci"
        )
        self.assertEqual(
            numinwords(418531, lang='lv'),
            "četri simti astoņpadsmit tūkstoši pieci simti trīsdesmit viens"
        )
        self.assertEqual(
            numinwords(1000139, lang='lv'),
    ...
    def test_to_ordinal(self):
        ...
        with self.assertRaises(NotImplementedError):
            numinwords(1, lang='lv', to='ordinal')

    def test_to_currency(self):
        self.assertEqual(
            numinwords(1.0, lang='lv', to='currency', currency='EUR'),
            "viens eiro, nulle centu"
        )
        self.assertEqual(
            numinwords(1.0, lang='lv', to='currency', currency='LVL'),
            "viens lats, nulle santīmu"
        )
        self.assertEqual(
            numinwords(1234.56, lang='lv', to='currency', currency='EUR'),
            "tūkstotis divi simti trīsdesmit četri eiro, piecdesmit seši centi"
        )
        self.assertEqual(
            numinwords(1234.56, lang='lv', to='currency', currency='LVL'),
    ...
    def test_fractions(self):
        self.assertEqual(numinwords(5.2, lang='lv'), "pieci komats divi")
        self.assertEqual(
            numinwords(561.42, lang='lv'),
